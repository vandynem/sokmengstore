...
class ControllerCheckoutCheckout extends Controller {
 ...
 if (isset($setting_so_onepagecheckout_general['so_onepagecheckout_city_id']) && $setting_so_onepagecheckout_general['so_onepagecheckout_city_id']) { 
 $data['city_id'] = $setting_so_onepagecheckout_general['so_onepagecheckout_city_id']; 
 } 
...
$data['error_warning'] = ''; 
 ...
 'city_id' => $this->getProperty($this->request->post, 'shipping_city_id'), 
...
'city_id' => $this->getProperty($this->request->post, 'payment_city_id'), 
...
city_id
 ...
 if (!$result[$prefix . 'city'] && $result[$prefix . 'city_id']) { 
 $city_info = $this->model_localisation_city->getCitysByZoneId($result[$prefix . 'city_id']); 
 if ($city_info) { 
 $result[$prefix . 'city'] = $city_info['name']; 
 } 
 } 
