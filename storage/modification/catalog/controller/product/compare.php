		...
		foreach ($this->session->data['compare'] as $key => $product_id) {
			...
			if ($product_info) {
				if ($product_info['image']) {
					...
					$image = $this->model_tool_image->resize($placeholder,$this->config->get('theme_' . $this->config->get('config_theme') . '_image_compare_width'), $this->config->get('theme_' . $this->config->get('config_theme') . '_image_compare_height'));
				}
