		...
		foreach ($results as $result) {
			...
			if ($product_info) {
				if ($product_info['image']) {
					...
					$image = $this->model_tool_image->resize($placeholder, $this->config->get('theme_' . $this->config->get('config_theme') . '_image_wishlist_width'), $this->config->get('theme_' . $this->config->get('config_theme') . '_image_wishlist_height'));
				}
