...
class ControllerCommonColumnLeft extends Controller {
 ...
 'children' => $magentech 
			...
			if ($this->user->hasPermission('access', 'marketing/flashsale')) {
				$marketing[] = array(
					'name'	   => $this->language->get('text_flashsale'),
					'href'     => $this->url->link('marketing/flashsale', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			if ($marketing) {
			...
			include($astra_path . 'Astra.php');
				...
				if (class_exists('Astra')) {
					$astra = new Astra();
					$astra_website_id = defined("CZ_SITE_KEY") ? CZ_SITE_KEY : "";
				 }
			}

			if(empty($astra_website_id)){
				$astra_website_id = "";
			}
...
// Catalog
			...
			if ($this->user->hasPermission('access', 'setting/setting')) {
				$astra_oc[] = array(
					'name'	   => "Dashboard",
					'href'     => "https://dash.getastra.com/dashboard/$astra_website_id",
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'setting/setting')) {
				$astra_oc[] = array(
					'name'	   => "Threats",
					'href'     => "https://dash.getastra.com/threats/$astra_website_id",
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'setting/setting')) {
				$astra_oc[] = array(
					'name'	   => "Settings",
					'href'     => "https://dash.getastra.com/settings/$astra_website_id",
					'children' => array()
				);
			}
    	...
    	if ($this->user->hasPermission('access', 'setting/setting')) {
				$astra_oc[] = array(
					'name'	   => "Support",
					'href'     => "https://dash.getastra.com/support",
					'children' => array()
				);
			}
