	...
	protected function getList() {
		...
		foreach ($results as $result) {
			if (is_file(DIR_IMAGE . $result['image'])) {
				...
				$image = $this->model_tool_image->resize('no_product.png', 40, 40);
			}
 ...
 'tab_title' => $product_tabtitle,
	...
	protected function getForm() {
		...
		if (isset($this->request->post['image']) && is_file(DIR_IMAGE . $this->request->post['image'])) {
			...
			$data['thumb'] = $this->model_tool_image->resize('no_product.png', 100, 100);
		}

		$data['placeholder'] = $this->model_tool_image->resize('no_product.png', 100, 100);
