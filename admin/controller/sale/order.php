...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
		    $this->log->write($result['payment_method']);
		...
		$data['sort_payment_method'] = $this->url->link('sale/order', 'user_token=' . $this->session->data['user_token'] . '&sort=payment_method' . $url, true);
		$data['sort_srno'] = $this->url->link('sale/order', 'user_token=' . $this->session->data['user_token'] . '&sort=srno' . $url, true);
