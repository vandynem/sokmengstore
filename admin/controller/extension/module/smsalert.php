...
class ControllerExtensionModuleSmsAlert extends Controller {
	...
	protected function getList() {
		...
		//Added by Avinash
		$data['smsalert_auth_url'] = $this->config->get('smsalert_auth_url');
	...
	/*	$this->db->query("INSERT INTO `" . DB_PREFIX . "sms_template` (`sms_template_id`, `type`, `store_id`, `name`, `bcc`) VALUES
		...
		$this->db->query("INSERT INTO `" . DB_PREFIX . "sms_template` (`sms_template_id`, `type`, `store_id`, `name`, `bcc`) VALUES
	 (1, 'register', 0, 'Account Registration (Default)', ''),
	 (2, 'order', 0, 'Order Confirmation (Default)', ''),
	 (3, 'forgotten', 0, 'Forgotten Password (Default)', ''),
	 (4, 'account_approve', 0, 'Account Approval (Default)', ''),
	 (5, '2', 0, 'Processing (Default)', '');
	 ");
