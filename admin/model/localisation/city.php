...
class ModelLocalisationCity extends Model {
    ...
    public function getCitys($data = array()) {
        $sql = "SELECT *, z.name as city, c.name AS zone,z.code as code FROM " . DB_PREFIX . "city z LEFT JOIN " . DB_PREFIX . "zone c ON (z.zone_id = c.zone_id)";
    ...
    public function getCityByZoneId($city_id) {
    ...
    public function getCityByZoneId1($zone_id) {
    ...
    public function getTotalAllCity() {
        $query = $this->db->query("SELECT *  FROM " . DB_PREFIX . "city");
        
        return $query->rows;
    }
    
    public function getTotalCityByZoneId($zone_id) {
