...
class ModelExtensionModuleSoOnepageCheckout extends Model {
    ...
    public function save($new_data = null) {
        ...
        if ($this->order_id) {
            ...
            if ($address_info) {
                ...
                $this->order_data['payment_city_id']        = $this->config->get('config_city_id');
                ...
                $this->order_data['shipping_city_id']       = $this->config->get('config_city_id');
            }
    ...
    private function editDBOrderOC2() {
        ...
        $this->db->query("UPDATE `" . DB_PREFIX . "order` 
            SET invoice_prefix = '" . $this->db->escape($data['invoice_prefix']) . "',
                ...
                payment_city_id = '" . (int)$data['payment_city_id'] . "',
                ...
                shipping_city_id = '" . (int)$data['shipping_city_id'] . "',
    ...
    public function getAddress($type) {
        ...
        $city_info = $this->model_localisation_city->getCity($result['city_id']);
        if ($city_info) {
            $result['city'] = $city_info['name'];
            $result['city_name'] = $city_info['name'];
            $result['city_code'] = $city_info['code'];
        } else {
            $result['city'] = '';
            $result['city_name'] = '';
            $result['city_code'] = '';
        ...
        $this->session->data[$type . '_city_id'] = $this->getProperty($this->session->data, $type . '_address.city_id');
