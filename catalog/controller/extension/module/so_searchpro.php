...
class ControllerExtensionModuleSosearchpro extends Controller {
	...
	public function index( $setting ) { 
		...
		$this->document->addStyle('catalog/view/javascript/so_searchpro/css/chosen.css');
		$this->document->addStyle('catalog/view/javascript/so_searchpro/css/so_searchpro.css');
		$this->document->addScript('catalog/view/javascript/so_searchpro/js/chosen.jquery.js');
